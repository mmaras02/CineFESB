...
const MovieDetailsList = ({movies,cinemas}) => {
    ...
    const toggleReviewForm = () => {
      ...
      const handleReviewSubmit = (newReview) => {
        // Update the reviews data, for example, send it to the server
        // After updating, close the review form and refresh the reviews
        // You may need to modify this logic based on your data structure and API communication
        allReviews(true); // Assuming you want to show all reviews after submitting a new one
 ...
 /*<span className="titles">IMDb rating: </span> */
